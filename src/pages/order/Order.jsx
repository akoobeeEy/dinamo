...
const Order = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="py-12">
        <h1 className="font-black text-[22px] md:text-[28px] text-titleColor mb-6">
          Оформление заказа
        </h1>
          ...
          <form onSubmit={handleSubmit((data) => console.log(data))}>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10">
              <div className="col-span-12  xl:col-span-8">
                {/* Contact information */}
                <div className="mb-10">
                  <h4 className="uppercase font-normal text-sm md:text-base text-titleColor mb-4 tracking-wider">
                  ...
                  <div className="flex flex-col gap-2">
                    {Object.entries(orderData).map(([key, item]) =>
                      item.type !== "select" ? (
                        <div key={key} className="flex flex-col mb-3">
                          <input
                            type={item.type}
                            className={`w-full sm:w-[431px] focus:outline-none bg-trafficWhite border-b h-10 px-2 text-sm md:text-lg ${
                              errors[key]
                                ? "border-red-500"
                                : "border-titleColor"
                            } text-[#99969A]`}
                    ...
                    <textarea
                      className="w-full sm:w-[431px] lg:w-full focus:outline-none text-[#99969A] bg-trafficWhite border-titleColor border-b h-[78px] p-2 text-sm md:text-lg"
                ...
                <div className="mb-10">
                  ...
                  <div className="py-2 px-4">
                    <h5 className="text-sm md:text-base font-normal text-textColor">
